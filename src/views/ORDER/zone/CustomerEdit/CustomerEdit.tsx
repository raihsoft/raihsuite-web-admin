...
import { apiGetEmployeeById, apiUpdateEmployee, apiDeleteEmployee, apiGetZoneById, apiUpdateZone } from '@/services/CustomersService'
...
const CustomerEdit = () => {
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        try {
            ...
            await apiUpdateZone(id as string, values)
