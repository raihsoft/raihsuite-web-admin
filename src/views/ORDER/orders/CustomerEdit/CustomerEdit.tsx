...
import { apiGetEmployeeById, apiUpdateEmployee, apiDeleteEmployee, apiGetZoneById, apiUpdateZone, apiGetOrderById, apiUpdateOrder } from '@/services/CustomersService'
...
const CustomerEdit = () => {
    ...
    const { data, isLoading, mutate } = useSWR(
        id ? `/api/${id}/` : null,
        () => apiGetOrderById<Customer>(id as string),
        {
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        try {
            ...
            await apiUpdateOrder(id as string, values)
    ...
    const getDefaultValues = () => {
        if (!data) return {}
        const {
            order_by_name,mobile,quantity,delivery_place,zone_name,order_type,organization,status
        } = data
        ...
        <>
            ...
            {!isLoading && data && (
                <>
                    ...
                    >
                        <p>Are you sure you want to remove this order? This action can&apos;t be undone.</p>
                    </ConfirmDialog>
                </>
            )}
        </>
