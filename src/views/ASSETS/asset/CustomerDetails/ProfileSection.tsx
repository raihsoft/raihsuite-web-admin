    ...
    return (
        <div className="min-h-screen bg-gray-50 p-8 flex justify-center">
            ...
            <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg border border-gray-200">
                ...
                {/* Footer */}
                {data.file_extension && (
                    <div className="px-8 py-6 bg-gray-50 border-t rounded-b-xl">
                        <a
                            href={data.file_extension}
                            target="_blank"
                            rel="noreferrer"
                            className="inline-block bg-blue-600 text-white px-5 py-2.5 rounded-md font-semibold hover:bg-blue-700 transition"
                        >
                            View File
                        </a>
                    </div>
